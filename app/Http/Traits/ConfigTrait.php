...
trait ConfigTrait
{
    ...
    private function storeConfig(array $params): bool
    {
        ...
        $configData = [
            ...
            'ffmpeg_cmd' => $sourceUrl ? "nohup ffmpeg -i '$sourceUrl' -c:v libx264 -preset veryfast -crf 23 -c:a aac -b:a 128k -hls_time 2 -hls_wrap 10 /tmp/$streamName/stream.m3u8 > /tmp/$streamName/ffmpeg.log 2>&1 &" : null,
        ];
